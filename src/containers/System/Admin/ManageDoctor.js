    ...
    handleChangeSelect = async (selectedOption) => {
        ...
        if (res && res.errCode === 0 && res.data && res.data.Markdown) {
            ...
            if (res.data.Doctor_Infor) {
                ...
                specialtyId = res.data.Doctor_Infor.specialtyId; //bug #92
            ...
            this.setState({
                ...
                selectedSpecialty: selectedSpecialty, //bug #92
    ...
    render() {
        ...
        return (
            <div className='manage-doctor-container'>
                ...
                <button
                    className={hasOldData === true ? "save-content-doctor" : "create-content-doctor"} //'save-content-doctor'
